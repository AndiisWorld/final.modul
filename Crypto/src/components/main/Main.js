...
<button className='reg_but' onClick={this.openSignUpModal}>Начать сейчас</button>
 ...
 <Modal open={this.state.openSignUpModal} onClose={this.onCloseModal} classNames='modal'>
      <div className="modal-header">
        <h5 className="modal-title">Hesab yarat</h5>
      </div>
      <div className="modal-body">
        <form>
          <div className="mb-3">
            <label className="col-form-label">Giriş daxil edin:</label>
            <input type="text" className="form-control"></input>
          </div>
          <div className="mb-3">
            <label type='text' className="col-form-label">Parol daxil edin:</label>
            <input 
            type='password'
          ...
          <div className="mb-3">
            <label type='text' className="col-form-label">Şifrəni yenidən daxil edin:</label>
            <input 
            type='password'
      ...
      <div className="modal-footer">
        ...
        <button type="button" className="btn btn-dark" onClick={this.onClickRegister}>Qeydiyyatdan keçin</button>
      </div>
                </Modal>   
