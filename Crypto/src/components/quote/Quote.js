...
<p>Qiymət rublla:&nbsp;{Math.round(btcPrice*usdPrice)}</p>
</div>
<div className='quote__block'>
...
<p>Qiymət rublla:&nbsp;{Math.round(ethPrice*usdPrice)}</p>
</div>
<div className='quote__block'>
...
<p>Qiymət rublla:&nbsp;{Math.round(xrpPrice*usdPrice)}</p>
</div>
<div className='quote__block'>
...
<p>Qiymət rublla:&nbsp;{Math.round(bnbPrice*usdPrice)}</p>
</div>
<div className='quote__block'>
...
<p>Qiymət rublla:&nbsp;{Math.round(usdPrice)}</p>
</div>
            </div>
        )
    }
