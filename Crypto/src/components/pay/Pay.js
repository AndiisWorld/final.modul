...
<div className="pay-header">
        <h5 className="pay-header-title">1. Valyuta seçin</h5>
      </div>
      <div className="pay-body">
        <form>
          <div className="pay-body-current">
            <label className="">Daxil edilən valyuta*</label>
            ...
            <p className='pay-info'>*qiymət dollarla hesablanır</p>
          </div>
          <div className="pay-body-current">
            <label className="">Kəmiyyət</label>
            <input 
            type='number'
          ...
          <div className="pay-body-current">
            <label className="">Cəmi ödənilməli</label>
            <input 
            type="number" 
            className="pay-end"
            value={this.state.finalCurrency}
            ></input>
            <button type='button' onClick={this.getSum} className='pay-sum'>Xərcləri hesablayın</button>
          </div>
          <div class="pay-body-current">
            <label type='text' className="">Ödəniş üsulu</label>
            <button className='pay-button' disabled="disabled">Seçilmiş</button>
          </div>
          <div className='pay-body-info'>
<input type='checkbox' className='pay-checkbox-one'></input>
<p>Bank kartları (Visa/MasterCard)
  <br/>
  <span className='pay-com'>Komissiya 1,6%</span>
</p>
...
<p>Apple Pay</p>
        ...
        <button type="button" className="btn-footer">Kriptovalyuta girişi</button>
      </div>
      </div>
      </div>
      <Footer />
